  ...
  if (!user) {
    return (
      <View style={styles.errorContainer}>
        <Icon name="account-off" size={64} color={Colors.TEXT_TERTIARY} />
      ...
      <ScrollView style={styles.content}>
            ...
            <View style={styles.badgesContainer}>
              {user.isVerified && (
                <View style={styles.verifiedBadge}>
                  <Icon name="check-decagram" size={16} color={Colors.TEXT_WHITE} />
                </View>
              )}
              {user.role === 'admin' && (
        ...
        <View style={styles.infoSection}>
          <View style={styles.infoItem}>
            <Icon name="information" size={20} color={Colors.TEXT_SECONDARY} />
