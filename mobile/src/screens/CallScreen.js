  ...
  return (
    <View style={styles.container}>
      ...
      {!isMinimized && (
        ...
        >
          <Icon name="window-minimize" size={24} color={Colors.TEXT_WHITE} />
        </TouchableOpacity>
      )}
      ...
      {isMinimized && (
        ...
        >
          ...
          <Icon name="window-maximize" size={24} color={Colors.TEXT_WHITE} />
        </TouchableOpacity>
      )}
        ...
        <View style={styles.controls}>
          ...
          {callType === 'video' && (
            <>
              ...
              >
                <Icon name="camera-flip" size={28} color={Colors.TEXT_WHITE} />
              </TouchableOpacity>
            </>
          )}
          ...
          <TouchableOpacity
            ...
            onPress={endCall}
          >
            <Icon name="phone-hangup" size={28} color={Colors.TEXT_WHITE} />
          </TouchableOpacity>
        </View>
      )}
    </View>
