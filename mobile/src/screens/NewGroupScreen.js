    ...
    return (
      <TouchableOpacity
        ...
        <View
          ...
          {isSelected && (
            <Icon name="check" size={18} color={Colors.TEXT_WHITE} />
          )}
        </View>
      </TouchableOpacity>
    );
          ...
          <TouchableOpacity
            ...
            {groupAvatar ? (
              ...
              <View style={styles.avatarPlaceholder}>
                <Icon name="camera" size={32} color={Colors.TEXT_SECONDARY} />
              </View>
            )}
          </TouchableOpacity>
          ...
          <FlatList
            ...
            ListEmptyComponent={
              <View style={styles.emptyContainer}>
                <Icon name="account-search" size={48} color={Colors.TEXT_TERTIARY} />
