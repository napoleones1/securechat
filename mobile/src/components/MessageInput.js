    ...
    <View style={styles.container}>
      <View style={styles.inputContainer}>
        ...
        <TouchableOpacity style={styles.iconButton}>
          <Icon name="emoticon-happy-outline" size={24} color={Colors.TEXT_SECONDARY} />
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <Icon name="paperclip" size={24} color={Colors.TEXT_SECONDARY} />
        </TouchableOpacity>

        {/* Send or Mic Button */}
        {message.trim() ? (
          <TouchableOpacity style={styles.sendButton} onPress={handleSend}>
            <Icon name="send" size={24} color={Colors.TEXT_WHITE} />
          </TouchableOpacity>
        ) : (
          <TouchableOpacity
            ...
            <Icon name="microphone" size={24} color={Colors.TEXT_WHITE} />
          </TouchableOpacity>
        )}
      </View>
          ...
          <View style={styles.attachMenu}>
            <TouchableOpacity style={styles.attachItem} onPress={handleImagePick}>
              <View style={[styles.attachIcon, { backgroundColor: '#9C27B0' }]}>
                <Icon name="image" size={24} color={Colors.TEXT_WHITE} />
              </View>
            ...
            <TouchableOpacity style={styles.attachItem} onPress={handleFilePick}>
              <View style={[styles.attachIcon, { backgroundColor: '#2196F3' }]}>
                <Icon name="file-document" size={24} color={Colors.TEXT_WHITE} />
              </View>
