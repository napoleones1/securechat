  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.badgesContainer}>
          {callerInfo?.isVerified && (
            <View style={styles.verifiedBadge}>
              <MaterialCommunityIcons name="check-decagram" size={20} color={Colors.TEXT_WHITE} />
            </View>
          )}
      ...
      <View style={styles.actions}>
        ...
        >
          <View style={styles.actionButtonInner}>
            <MaterialCommunityIcons name="phone-hangup" size={32} color={Colors.TEXT_WHITE} />
          </View>
        ...
        >
          <View style={styles.actionButtonInner}>
            <MaterialCommunityIcons name={callType === 'video' ? 'video' : 'phone'}
              size={32}
      ...
      <View style={styles.quickActions}>
        ...
        <TouchableOpacity style={styles.quickActionButton}>
          <MaterialCommunityIcons name="clock-outline" size={24} color={Colors.TEXT_WHITE} />
