...
const ChatsListScreen = ({ navigation }) => {
  ...
  const getMessageStatus = (message) => {
    ...
    return <MaterialCommunityIcons name={icon} size={16} color={color} style={{ marginRight: 5 }} />;
  };
    ...
    <View style={styles.container}>
      ...
      {filteredChats.length === 0 ? (
        <View style={styles.emptyContainer}>
          <MaterialCommunityIcons name="message-text-outline" size={64} color={Colors.TEXT_TERTIARY} />
      ...
      <TouchableOpacity
        ...
        <MaterialCommunityIcons name="message-plus" size={24} color={Colors.TEXT_WHITE} />
      </TouchableOpacity>
    </View>
  );
};
