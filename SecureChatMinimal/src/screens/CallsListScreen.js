      ...
      >
        ...
        <View style={styles.callInfo}>
          ...
          <View style={styles.callDetails}>
            <MaterialCommunityIcons name={callIcon.name}
              size={16}
        ...
        <View style={styles.callActions}>
          ...
          >
            <MaterialCommunityIcons name={item.callType === 'video' ? 'video' : 'phone'}
              size={24}
              color={Colors.PRIMARY}
            />
          </TouchableOpacity>
    ...
    return (
      <View style={styles.container}>
        <View style={styles.emptyContainer}>
          <MaterialCommunityIcons name="phone-outline" size={64} color={Colors.TEXT_TERTIARY} />
