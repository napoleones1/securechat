    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity
        ...
        <View style={styles.groupIcon}>
          <MaterialCommunityIcons name="account-multiple" size={24} color={Colors.TEXT_WHITE} />
        </View>
      ...
      {loading ? (
        ...
        <View style={styles.emptyContainer}>
          <MaterialCommunityIcons name="account-search" size={64} color={Colors.TEXT_TERTIARY} />
