  ...
  if (!chat) {
    return (
      <View style={styles.errorContainer}>
        <MaterialCommunityIcons name="account-group-outline" size={64} color={Colors.TEXT_TERTIARY} />
          ...
          <TouchableOpacity onPress={pickImage} disabled={!isAdmin()}>
            ...
            {isAdmin() && (
              <View style={styles.avatarOverlay}>
                <MaterialCommunityIcons name="camera" size={32} color={Colors.TEXT_WHITE} />
              </View>
            )}
          </TouchableOpacity>
        </View>
